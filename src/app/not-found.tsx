...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] py-12 text-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-5xl font-extrabold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-indigo-600 font-serif">404</h1>
        ...
        <div className="space-y-6">
          <div style={styles.errorSection} className="p-6 text-white text-left rounded-xl mb-8">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                <i className="fas fa-chevron-right mr-2 text-sm"></i>
                <Link href="/brand/pringles" className="hover:underline">Explore Pringles recipes</Link>
              </li>
            </ul>
          </div>
          ...
          <Link 
            href="/" 
            className="inline-flex items-center px-6 py-3 text-white rounded-md font-medium"
            style={{
              ...styles.accentButton,
